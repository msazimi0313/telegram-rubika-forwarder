...
def main():
    ...
    app.add_handler(MessageHandler((filters.COMMAND & filters.Regex('^/stats$')) | (filters.TEXT & filters.Regex('^📊 آمار$')), admin_stats, filters=admin_filter))
    app.add_handler(MessageHandler((filters.COMMAND & filters.Regex('^/clearstats$')) | (filters.TEXT & filters.Regex('^🗑 پاک کردن آمار$')), admin_clear_stats, filters=admin_filter))
