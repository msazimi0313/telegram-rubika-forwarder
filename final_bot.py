...
async def admin_stats(update: Update, context: ContextTypes.DEFAULT_TYPE):
    # This function is intentionally left simple as per previous discussions
    # to avoid complexity with the stats file structure.
    await update.message.reply_text("در حال آماده سازی آمار...")
